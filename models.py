...
class Employee(AbstractBaseUser, PermissionsMixin):
    ...
    perm_reports_grv      = models.BooleanField(default=False, verbose_name='GRV Reports View')
    ...
    # Work Permit
    perm_wp_view          = models.BooleanField(default=True,  verbose_name='WP View')
    perm_wp_write         = models.BooleanField(default=True,  verbose_name='WP Write')
    perm_wp_approve       = models.BooleanField(default=False, verbose_name='WP Approve/Reject')
    perm_wp_delete        = models.BooleanField(default=False, verbose_name='WP Delete')
    perm_wp_report        = models.BooleanField(default=False, verbose_name='WP Reports')
...
class SystemSetting(models.Model):
    ...
    wp_prefix = models.CharField(max_length=10, default='WP', verbose_name='Work Permit Prefix')
    wp_next_number = models.PositiveIntegerField(default=1, verbose_name='WP Next Number')
    wp_doc_ref = models.CharField(max_length=30, default='PTW-F-001', verbose_name='WP Document Reference')
    wp_rev = models.CharField(max_length=10, default='01', verbose_name='WP Revision Number')
    ...
    notif_wp_popup = models.BooleanField(default=True, verbose_name='WP Popup Notifications')
    notif_wp_email = models.BooleanField(default=True, verbose_name='WP Email Notifications')
...
class RolePermissionTemplate(models.Model):
    ...
    perm_reports_grv     = models.BooleanField(default=False)
    ...
    perm_wp_view         = models.BooleanField(default=True)
    perm_wp_write        = models.BooleanField(default=True)
    perm_wp_approve      = models.BooleanField(default=False)
    perm_wp_delete       = models.BooleanField(default=False)
    perm_wp_report       = models.BooleanField(default=False)
    ...
    PERM_FIELDS = [
        ...
        'perm_reports_igp','perm_reports_vgp','perm_reports_mgp','perm_reports_grv','perm_reports_audit',
        ...
        'perm_wp_view','perm_wp_write','perm_wp_approve','perm_wp_delete','perm_wp_report',
    ]
...
class DailyQuote(models.Model):
    """365 daily inspiration quotes — one shown per day based on day-of-year."""
    day_number  = models.PositiveSmallIntegerField(unique=True, help_text='1–365')
    ...
    def __str__(self):
        return f'Day {self.day_number}: {self.quote[:60]}'

    @classmethod
    def today(cls):
        from django.utils import timezone
        day = timezone.localdate().timetuple().tm_yday  # 1-365
        return cls.objects.filter(day_number=day).first()
